...
class TestTrackerConfiguration: XCTestCase {
    func testNetworkConfiguration_EmptyEndpoint_Fails() {
        ...
        let tracker = PSATracker.createTracker(namespace: "namespace", network: networkConfig, configurations: [trackerConfig])
    ...
    func testSessionInitialization() {
        ...
        let tracker = PSATracker.createTracker(namespace: "namespace", network: networkConfig, configurations: [trackerConfig, sessionConfig])
    ...
    func testSessionControllerUnavailableWhenContextTurnedOff() {
        ...
        var tracker = PSATracker.createTracker(namespace: "namespace", network: networkConfig, configurations: [trackerConfig])
        XCTAssertNotNil(tracker?.session)

        trackerConfig.sessionContext = false
        tracker = PSATracker.createTracker(namespace: "namespace", network: networkConfig, configurations: [trackerConfig])
    ...
    func testSessionConfigurationCallback() {
        ...
        guard let tracker = PSATracker.createTracker(namespace: "namespace", network: networkConfig, configurations: [trackerConfig, sessionConfig]) else { return XCTFail() }
    ...
    func testTrackerVersionSuffix() {
        ...
        let trackerController = PSATracker.createTracker(namespace: "namespace", network: networkConfiguration, configurations: [trackerConfiguration, emitterConfiguration])
    ...
    func testGDPRConfiguration() {
        ...
        let trackerController = PSATracker.createTracker(namespace: "namespace", network: networkConfiguration, configurations: [trackerConfiguration, gdprConfiguration, emitterConfiguration])
