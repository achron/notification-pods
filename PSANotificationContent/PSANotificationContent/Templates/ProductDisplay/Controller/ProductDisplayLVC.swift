...
@objc public class ProductDisplayLVC: BaseNotificationContentVC,UIGestureRecognizerDelegate{
    ...
    func createView() {
        ...
        if let img3 = jsonContent.img3, !img3.isEmpty ,(jsonContent.btnTitle3 != nil && jsonContent.btnSubTitle3 != nil && jsonContent.deepLink3 != nil){
    ...
    */
    ...
    public init() {
        super.init(nibName: "ProductDisplayLVC", bundle: Bundle(for: ProductDisplayLVC.self))
    }
