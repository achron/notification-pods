...
class CaptionImageView : UIView {
    ...
    private var subcaptionLabel: UILabel = {
        ...
        subcaptionLabel.numberOfLines = 0
    ...
    func setUpViews() {
        ...
        Utiltiy.checkImageUrlValid(imageUrl: components.imageUrl) { [weak self] (imageData) in
    ...
    func setupConstraints() {
        NSLayoutConstraint.activate([
            captionLabel.topAnchor.constraint(equalTo: bottomAnchor, constant: -(Utiltiy.getCaptionHeight() - Constraints.kCaptionTopPadding)),
    ...
    func activateImageViewContraints() {
        NSLayoutConstraint.activate([
           ...
           imageView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -Utiltiy.getCaptionHeight())
        ])
    }
}
